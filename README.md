...
- There is a sentiment on the web that the use of system(ssh cmd) is ***NOT recommended*** for anything but simple quick use cases. Reason system() is less equipped to handle errors or responses in a programatic way. Hense why they recommend using libssh for building clients. Truth is I dont know if this is a valid reason not use it. Until I live it and have a better understanding of the pitfalls I would use it system() call as libssh was a real pain in the ass to use.
